...
import (
	...
	"github.com/tencent/bk-cmdb/scene_server/admin_server/app/options"
	"github.com/tencent/bk-cmdb/scene_server/admin_server/configures"
	svc "github.com/tencent/bk-cmdb/scene_server/admin_server/service"
...
func Run(ctx context.Context, op *options.ServerOption) error {
	...
	pconfig, err := cc.ParseConfigWithFile(op.ServConf.ExConfig)
	if nil != err {
