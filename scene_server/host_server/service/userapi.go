...
import (
	...
	"github.com/tencent/bk-cmdb/common/paraparse"
...
func (s *Service) AddUserCustomQuery(req *restful.Request, resp *restful.Response) {
	...
	if nil != err || (nil == err && !result.Result) {
		...
		resp.WriteError(http.StatusInternalServerError, &meta.RespError{Msg: defErr.Errorf(common.CCErrAddUserCustomQueryFaild, err.Error())})
		return
	}
...
func (s *Service) UpdateUserCustomQuery(req *restful.Request, resp *restful.Response) {
	...
	if nil != err || (nil == err && !result.Result) {
		...
		resp.WriteError(http.StatusInternalServerError, &meta.RespError{Msg: defErr.Errorf(common.CCErrUpdateUserCustomQueryFaild, err.Error())})
		return
	}
...
func (s *Service) DeleteUserCustomQuery(req *restful.Request, resp *restful.Response) {
	...
	if nil != err || (nil == err && !result.Result) {
		...
		resp.WriteError(http.StatusInternalServerError, &meta.RespError{Msg: defErr.Errorf(common.CCErrDeleteUserCustomQueryFaild, err.Error())})
		return
	}
...
func (s *Service) GetUserCustomQuery(req *restful.Request, resp *restful.Response) {
	...
	if nil != err || (nil == err && !result.Result) {
		...
		resp.WriteError(http.StatusInternalServerError, &meta.RespError{Msg: defErr.Errorf(common.CCErrSearchUserCustomQueryFaild, err.Error())})
		return
	}
...
func (s *Service) GetUserCustomQueryDetail(req *restful.Request, resp *restful.Response) {
	...
	if nil != err || (nil == err && !result.Result) {
		...
		resp.WriteError(http.StatusInternalServerError, &meta.RespError{Msg: defErr.Errorf(common.CCErrGetUserCustomQueryDetailFaild, err.Error())})
		return
	}
...
func (s *Service) GetUserCustomQueryResult(req *restful.Request, resp *restful.Response) {
	...
	if nil != err {
		...
		resp.WriteError(http.StatusInternalServerError, &meta.RespError{Msg: defErr.Error(common.CCErrCommJSONUnmarshalFailed)})
		return
	}
