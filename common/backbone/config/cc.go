...
import (
	...
	crd "github.com/tencent/bk-cmdb/common/confregdiscover"
...
func NewConfigWithZookeeper(ctx context.Context, zkAddr string, procName string, confPath string, handler *CCHandler) error {
